...
export class MedecinComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.medecinService
      ...
      .subscribe({
        next: (res: HttpResponse<IMedecin[]>) => {
  ...
  trackId(_index: number, item: IMedecin): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IMedecin[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
