...
describe('ShiftHoraire Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'shift-horaire', component: ShiftHoraireComponent }]), HttpClientTestingModule],
      declarations: [ShiftHoraireComponent],
      providers: [
        {
      ...
      .overrideTemplate(ShiftHoraireComponent, '')
      .compileComponents();
