...
describe('Appointement Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'appointement', component: AppointementComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.appointements?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
