...
import { EntityArrayResponseType, AppointementService } from '../service/appointement.service';
...
export class AppointementComponent implements OnInit {
  ...
  trackId = (_index: number, item: IAppointement): number => this.appointementService.getAppointementIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.appointements = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IAppointement[] | null): IAppointement[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.appointementService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
